...
| `docs/brief-p7.md` | co domówić przez SpriteCook: wynik testu, zasady pracy z narzędziem, kolejka ikon |
| `docs/brief-p6.md` | brief P6: dwie ikony dźwięku do paska górnego |
